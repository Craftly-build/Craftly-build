...
const ReviewsSection = () => {
  ...
  const reviews = [
     {
        ...
        name: 'Jem Love' ,
        rating: 4,
        review: 'Great quality, but I wish they had more sizes...'
     ...
     },
     {
        ...
        name: 'Olamide Ola' ,
        rating: 5,
        review: 'Love these heels! They are comfortable, stylish...'
     ...
     {  
        ...
        name: 'Jemmimah Ola' ,
        rating: 4.5,
        review: 'These heels are worth every naira, will buy.'
  ...
  const displayedReviews = reviews.slice(0, reviewer * ReviewsPerPage)
  const totalReviews = reviews.length

  const showAll = () => {
    setReviewer(prev => prev + 1);
